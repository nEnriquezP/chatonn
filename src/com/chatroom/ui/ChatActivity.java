...
public class ChatActivity {
	...
	private JButton jBtnSend;
        private JButton jBtnEMj1;
        private JButton jBtnEMj2;
        private JButton jBtnEMj3;
        private JButton jBtnEMj4;
        private JButton jBtnEMj5;
	...
	public ChatActivity(ClientModel clientModel) throws IOException {
		...
		jFrame = new JFrame("LIVE CAHT");
		jPanel = new JPanel();
		jPanelChatWindow = new JPanel();
		optionsButtonsHolder = new JPanel();
		Image iconLogo = ImageIO.read(this.getClass().getResource("/logo.png"));
                jFrame.setIconImage(new ImageIcon(iconLogo).getImage());
		messageListener = new MessageListener();
		messageListener.start();
		
		//creating compound border for Text Field to specify left margin to the text
		Border lineBorder = BorderFactory.createLineBorder(Config.colorPrimary, 1);
		...
		jBtnSend = new JButton("Send");
                ...
                Image fhImage= ImageIO.read(this.getClass().getResource("/fh.png"));
                Image nhImage= ImageIO.read(this.getClass().getResource("/nh.png"));
                Image nImage= ImageIO.read(this.getClass().getResource("/n.png"));
                Image nsImage= ImageIO.read(this.getClass().getResource("/ns.png"));
                Image fsImage= ImageIO.read(this.getClass().getResource("/fs.png"));
                
                jBtnEMj1 = new JButton();
               jBtnEMj1.setIcon(new ImageIcon(fhImage));
              
                 jBtnEMj2 = new JButton();
               jBtnEMj2.setIcon(new ImageIcon(nhImage));
              
                 jBtnEMj3 = new JButton();
               jBtnEMj3.setIcon(new ImageIcon(nImage));
              
                 jBtnEMj4 = new JButton();
               jBtnEMj4.setIcon(new ImageIcon(nsImage));
              
                 jBtnEMj5 = new JButton();
               jBtnEMj5.setIcon(new ImageIcon(fsImage));
              
               
               
                initializeAllWithProperties();
		displayStatusMessages("Joined Successfully ! ");
	...
	private void ListeningEvents() {
		...
		jBtnSend.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                ...
                jBtnEMj1.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				tracker = jScrollPane.getVerticalScrollBar().getMaximum();
				                        setSenderEMOJI(0);
                ...
                jBtnEMj2.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				tracker = jScrollPane.getVerticalScrollBar().getMaximum();
				                        setSenderEMOJI(1);
	        ...
	        jBtnEMj3.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				tracker = jScrollPane.getVerticalScrollBar().getMaximum();
				                        setSenderEMOJI(2);
	        ...
	        jBtnEMj4.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				tracker = jScrollPane.getVerticalScrollBar().getMaximum();
				                        setSenderEMOJI(3);
	        ...
	        jBtnEMj5.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				tracker = jScrollPane.getVerticalScrollBar().getMaximum();
				                        setSenderEMOJI(4);
	...
	private void setSenderMessage() {
		try {
        	...
        	private void setSenderEMOJI(int id) {
		try {
                    String mString="";
                                     if(id==0)
                                     {
				...
				//sending message to the server
				request = new Request(Request.Type.MSG.ordinal(),clientModel.getClientID(),clientModel.getRoomId(),mString);
				ClientModel.objectOutputStream.writeObject(request);
				ClientModel.objectOutputStream.flush();
				//displaying on the user UI window
				jLabelMessage = new JLabel();
                                ...
                                if(id==0)
                                  fhImage= ImageIO.read(this.getClass().getResource("/fh.png"));
                                else if(id==1)
                                  fhImage= ImageIO.read(this.getClass().getResource("/nh.png"));
                                else if(id==2)
                                  fhImage= ImageIO.read(this.getClass().getResource("/n.png"));
                                else if(id==3)
                                  fhImage= ImageIO.read(this.getClass().getResource("/ns.png"));
                                else if(id==4)
                                  fhImage= ImageIO.read(this.getClass().getResource("/fs.png"));
                              
                                
                                jLabelMessage.setIcon(new ImageIcon(fhImage));
				jLabelMessage.setBorder(rightBubble);
				rightBubbleConstraints.gridy = i;
				jPanelChatWindow.add(jLabelMessage,rightBubbleConstraints);
				jPanelChatWindow.revalidate();
	...
	private void setReceiverMessage(String senderName, String message) {
		...
		if(message.trim().length() <= 3)
			...
			temp = "300px";
	if(message.equals("FHico"))
        {
                    try {
                          String text = String.format("<html><p style=\"width:%s;word-break: break-all;\">%2$s</p></html>", temp, senderName + "<br>");
		jLabelMessage.setText(text);
                        Image fhImage= ImageIO.read(this.getClass().getResource("/fh.png"));
                        jLabelMessage.setIcon(new ImageIcon(fhImage));
        ...
        else 	if(message.equals("NHico"))
        {
                    try {
                          String text = String.format("<html><p style=\"width:%s;word-break: break-all;\">%2$s</p></html>", temp, senderName + "<br>");
		jLabelMessage.setText(text);
                        Image fhImage= ImageIO.read(this.getClass().getResource("/nh.png"));
                        jLabelMessage.setIcon(new ImageIcon(fhImage));
                    } catch (IOException ex) {
                        Logger.getLogger(ChatActivity.class.getName()).log(Level.SEVERE, null, ex);
                    }
        ...
        else 	if(message.equals("Nico"))
        {
                    try {
                          String text = String.format("<html><p style=\"width:%s;word-break: break-all;\">%2$s</p></html>", temp, senderName + "<br>");
		jLabelMessage.setText(text);
                        Image fhImage= ImageIO.read(this.getClass().getResource("/n.png"));
                        jLabelMessage.setIcon(new ImageIcon(fhImage));
                    } catch (IOException ex) {
                        Logger.getLogger(ChatActivity.class.getName()).log(Level.SEVERE, null, ex);
                    }
        ...
        else 	if(message.equals("NSico"))
        {
                    try {
                          String text = String.format("<html><p style=\"width:%s;word-break: break-all;\">%2$s</p></html>", temp, senderName + "<br>");
		jLabelMessage.setText(text);
                        Image fhImage= ImageIO.read(this.getClass().getResource("/ns.png"));
                        jLabelMessage.setIcon(new ImageIcon(fhImage));
                    } catch (IOException ex) {
                        Logger.getLogger(ChatActivity.class.getName()).log(Level.SEVERE, null, ex);
                    }
        ...
        else 	if(message.equals("FSico"))
        {
                    try {
                          String text = String.format("<html><p style=\"width:%s;word-break: break-all;\">%2$s</p></html>", temp, senderName + "<br>");
		jLabelMessage.setText(text);
                        Image fhImage= ImageIO.read(this.getClass().getResource("/fs.png"));
                        jLabelMessage.setIcon(new ImageIcon(fhImage));
                    } catch (IOException ex) {
                        Logger.getLogger(ChatActivity.class.getName()).log(Level.SEVERE, null, ex);
                    }
        ...
        else {       String text = String.format("<html><div style=\"font-size:8px;text-align:right;\">%3$s</div><div style=\"width:%1$spx;\"><p style=\"width:%s;word-break: break-all;\">%2$s</p></div></html>", temp, message, senderName + "<br>");
		jLabelMessage.setText(text);		
        }
	...
	private void initializeAllWithProperties() {
		...
		jBtnSend.setBorder(new LineBorder(Config.colorPrimary, 3));
		jBtnSend.setFocusPainted(false);
		jBtnSend.requestFocus();
		JPanel emojiPane= new JPanel();
                emojiPane.setLayout(new GridLayout(1,5));
                emojiPane.add(jBtnEMj1);
		 emojiPane.add(jBtnEMj2);
		 emojiPane.add(jBtnEMj3);
		 emojiPane.add(jBtnEMj4);
		 emojiPane.add(jBtnEMj5);
		
                 JPanel panelB = new JPanel(new GridLayout(1,2));
                 panelB.add(jBtnSend);
                 panelB.add(emojiPane);
